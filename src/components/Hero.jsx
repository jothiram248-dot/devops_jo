...
// // import NotificationCardToast from "@/pages/notifications/NotificationCardToast";
...
// //   const wordVariants = {
// //     hidden: { color: "#A0A0A0", opacity: 0.6, y: 5 }, // Light shade, slightly offset
// //     visible: {
// //       color: "#FFFFFF", // Final visible color
// //       opacity: 1,
// //       y: 0, // Moves to its original position
// //       transition: {
// //         duration: 0.4, // Time for each word animation
// //         ease: "easeInOut",
// //       },
// //     },
// //   };
...
// //               overflow: "hidden", // Prevent content from pushing down
...
// //             animate="visible"
// //             transition={{
// //               staggerChildren: 0.08, // Delay between word animations
// //             }}
...
// //                 fontFamily: '"helvetica", serif',
// //               }}
// //               className="text-xl md:text-xl lg:text-2xl leading-relaxed font-semibold text-[#A0A0A0]"
// //             >
// //               {words.map((word, index) => (
// //                 <motion.span
// //                   key={index}
// //                   variants={wordVariants} // Apply animation to each word
...
//   const { scrollY } = useScroll({ smooth: true }); // Use smooth scroll
//   const navigate = useNavigate();
//   const isAuthenticated = useSelector((state) => state.auth.isAuthenticated);
//   const controls = useAnimation();
//   const contentControls = useAnimation();
...
//   // Optimization: Debounce scroll handler
...
//   // Highly optimized transform values using threshold-based approach
//   // This prevents continuous recalculation on every scroll pixel
//   // Consistent values across mobile and desktop
...
//     scrollY,
//     [0, 300],
//     hasPassedThreshold ? [40, 40] : [15, 45] 
//     // 15, 45 -----> 0, 40
//   );
...
//           width: "300px",
//           height: "300px",
//           background: "radial-gradient(circle at 30% 30%, rgba(108, 99, 255, 0.15) 0%, rgba(82, 71, 200, 0.1) 40%, rgba(56, 52, 144, 0.05) 70%, transparent 100%)",
...
//           width: "250px",
//           height: "250px",
//           background: "radial-gradient(circle at 40% 40%, rgba(66, 158, 245, 0.12) 0%, rgba(55, 125, 192, 0.08) 40%, rgba(42, 89, 134, 0.04) 70%, transparent 100%)",
...
//           width: "220px",
//           height: "220px",
//           background: "radial-gradient(circle at 50% 50%, rgba(139, 92, 246, 0.06) 0%, rgba(124, 58, 237, 0.04) 40%, rgba(109, 40, 217, 0.02) 70%, transparent 100%)",
...
//           width: "180px",
//           height: "180px",
//           background: "radial-gradient(circle at 50% 50%, rgba(96, 165, 250, 0.08) 0%, rgba(59, 130, 246, 0.05) 40%, rgba(37, 99, 235, 0.02) 70%, transparent 100%)",
...
//     >
//       {/* Premium Background with Improved Performance */}
//       <div className="absolute inset-0 z-0 overflow-hidden">
//         {/* Deep space-like base gradient - static to improve performance */}
//         <div 
//           className="absolute inset-0" 
//           style={{
//             background: "radial-gradient(circle at 50% 50%, #121225 0%, #080816 50%, #030308 100%)",
//             opacity: 0.7
//           }}
//         ></div>
        
//         {/* Static rich gradient overlays - better performance */}
//         <div className="absolute inset-0 bg-gradient-to-br from-blue-900/10 via-transparent to-purple-900/10"></div>
//         <div className="absolute inset-0 bg-gradient-to-tl from-indigo-900/5 via-transparent to-teal-900/5"></div>
        
//         {/* Premium dust-like particle background - static */}
//         <div 
//           className="absolute inset-0 noise-texture" 
//           style={{ opacity: 0.2 }}
//         ></div>

//         {/* Simplified premium gradient overlay - static for better performance */}
...
//       {/* U-shaped background - enhanced for consistent mobile experience */}
//       <div className="absolute left-0 right-0 h-[90vh] overflow-hidden">
//         {/* U-shaped background with identical mobile/desktop curvature */}
//         <div 
//           className="absolute inset-0 z-10"
//           style={{
//             clipPath: "polygon(0 0, 100% 0, 100% 85%, 65% 100%, 35% 100%, 0 85%)",
...
//         {/* Main U-shaped video container - consistent across all devices */}
//         <motion.div
...
//             }}
//           >
//             {/* Video with enhanced mobile performance */}
//             <video
//               autoPlay
//               muted
//               loop
//               playsInline
//               className="w-full h-auto object-cover video-container"
//               style={{ 
//                 transform: "scale(1.01)", // Very slight scale to avoid edges 
...
//             {/* Enhanced gradient overlay consistent across devices */}
//             <div className="absolute inset-0 bg-gradient-to-b from-black/85 via-black/70 to-black/85"></div>
//           </div>
//         </motion.div>
        
//         {/* Premium bottom accent - consistent across devices */}
//         <div 
//           className="absolute bottom-0 left-[35%] right-[35%] h-[2px] z-10 bottom-accent-glow"
//         ></div>
//       </div>
...
//           className="relative mx-auto mb-12 md:mb-16 max-w-4xl will-change-transform perspective-1000 md:mt-4"
//         >
//           {/* 3D Transform container with consistent behavior across devices */}
//           <motion.div
//             style={{ 
//               scale: videoScale,
...
//             }}
//             className={`relative rounded-xl overflow-hidden border border-gray-600/30 ${videoGlowClass} ${isMobile ? 'mobile-video-container' : ''}`}
//           >
...
//             {/* Premium edge effects using CSS classes for better performance */}
...
//             {/* Premium corner highlights using CSS classes */}
...
//         {/* Get Started Button - mobile responsive with premium styling */}
//         <motion.div
//           initial={{ opacity: 0, y: 20 }}
//           animate={{ opacity: 1, y: 0 }}
//           transition={{ duration: 0.8, delay: 0.8 }}
...
//           background: radial-gradient(circle at 70% 60%, rgba(124, 58, 237, 0.04) 0%, transparent 50%);
//         }
...
//         .corner-bottom-left {
//           background: radial-gradient(circle at bottom left, rgba(59, 130, 246, 0.2), transparent 70%);
//           border-bottom-left-radius: 0.75rem;
//         }
        
//         .corner-bottom-right {
//           background: radial-gradient(circle at bottom right, rgba(59, 130, 246, 0.2), transparent 70%);
//           border-bottom-right-radius: 0.75rem;
//         }
        
//         /* Reflection glow */
//         .reflection-glow {
//           background: radial-gradient(ellipse at center, rgba(59, 130, 246, 0.08) 0%, rgba(79, 70, 229, 0.04) 50%, transparent 100%);
//           filter: blur(8px);
//         }
...
const Hero = () => {
  ...
  // Enhanced transform values for premium effect
  ...
  // Enhanced fade effect for the background video
  // Starts fading later and disappears more gradually for premium effect
