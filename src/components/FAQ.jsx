...
import { ChevronDown } from "lucide-react"; // removed Plus (unused)
...
const FAQItem = ({ question, answer }) => {
  ...
  return (
    <motion.div className="border-b border-gray-200 last:border-none" initial={false}>
      <button
    ...
    <section className="relative py-16 overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          {/* Single CTA button BELOW the FAQs (only when not authenticated) */}
          {!isAuthenticated && (
  <div className="mt-12 flex justify-center">
    <motion.button
      ...
      className="
        ...
        rounded-lg px-8 py-3 md:px-10 md:py-4
        text-base md:text-lg font-medium
        bg-accent-100 text-gray-900
        border border-black/5 shadow-sm
        hover:bg-accent-200 hover:shadow-md
        transition-[background-color,box-shadow,transform] duration-200
        focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-100/50 focus-visible:ring-offset-2
      "
    >
