...
const CredentialDetailsCard = ({
  ...
  // const handleSave = async (id, isOthers, isAccount, platformData) => {
  //   try {
  //     const updatedCredential = {
  //       category: type,
  //       data: {
  ...
  //           type === "banking" && isAccount
  //           ? {
  //               accountType: "Others",
  //               otherAccountType: editedData.accountType,
  //             }
  //           : type !== "gamingPlatform" &&
  //             type !== "socialMedia" &&
  //             type !== "entertainmentPlatform"
  ...
  //         // Add otherPlatformName condition
  //         ...(type === "others" &&
  //         [
  //           "E-Commerce Accounts",
  ...
  //         platformNameData
  //           ? { otherPlatformName: platformNameData }
  ...
  const handleSave = async (id, isOthers, isAccount, platformData) => {
    try {
      const updatedCredential = {
        ...
        // ].includes(initialDisplayName) &&
        // platformData
        //   ? { otherPlatformName: platformData }
        //   : initialDisplayName === "Music Streaming Platforms" ||
        //     initialDisplayName === "Adults Platforms"
        //   ? { otherPlatformName: platformData }
        //   : {}),
