      ...
      <div className="flex flex-col items-center">
        ...
        <div className="text-center w-full mb-8">
          <h1 className="text-5xl sm:text-6xl md:text-7xl font-bold text-white mb-6 leading-tight enterprise-heading">
            Manage Your <span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Credentials</span>
          </h1>
...
{/*           
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 items-center mt-4">
          ...
          >
            ...
            <p className="text-lg md:text-2xl text-gray-100 leading-relaxed dynamic-text">
              Store all your credentials in <span className="highlight-text">one centralized location</span> for
              easy access, eliminating the need to memorize them. This
              provides users with <span className="highlight-text">peace of mind</span> regarding where to store
              countless credentials, making it easy to access these
              details anytime and anywhere, while ensuring <span className="highlight-text">security</span> as a
              top priority.
            </p>
      ...
      __html: `
        ...
        function initialize3DParticles() {
          ...
          for (let i = 0; i < 40; i++) {
            ...
            // Enhanced randomization for immersive effect
            ...
            // Enhanced animation with variable parameters
        ...
        // Enhanced Data Stream Animation with Reactive Behavior
        ...
        // Advanced Holographic Tilt Effect with Depth
        function initializeHolographicEffect() {
          ...
          tiltElement.addEventListener('mousemove', e => {
            ...
            // Enhanced 3D rotation with depth
            ...
            // Advanced dynamic lighting effect that follows cursor
            if (glowEffect) {
  ...
  {/* Enhanced Custom Styles with Advanced Effects */}
  <style jsx>{`
  ...
  <div className="container mx-auto max-w-screen-xl px-6 relative z-10">
    ...
    >
      ...
      <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
        Start securing your digital credentials with our feature-rich
        free plan.
      </p>
    </motion.div>
